 ...
 * @date 2021-12-06
 */
public interface BawMediaCoverageMapper 
{
    /**
     * 查询媒体报道
     * 
     ...
     * @return 媒体报道集合
     */
    public List<ModelMap> selectBawMediaCoverageListForApi(@Param("isDelete") Integer isDelete, @Param("isDisable") Integer isDisable, @Param("year") Integer year, @Param("month") Integer month, @Param("keywords") String keywords);
