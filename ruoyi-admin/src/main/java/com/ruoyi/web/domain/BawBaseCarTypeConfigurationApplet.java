 ...
 * @date 2022-01-20
 */
public class BawBaseCarTypeConfigurationApplet extends BaseEntity
{
    ...
    public String getCarTypeCodeCn() {
        return carTypeCodeCn;
    }

    public void setCarTypeCodeCn(String carTypeCodeCn) {
        this.carTypeCodeCn = carTypeCodeCn;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("carTypeCodeCn", getCarTypeCodeCn())
